...
class ParentReport(Base):
    ...
    key_strengths: Mapped[dict] = mapped_column(JSONB, nullable=True)
    key_weaknesses: Mapped[dict] = mapped_column(JSONB, nullable=True)
    ...
    parent = relationship("User", back_populates="parent_reports", foreign_keys=[parent_id])
