...
class Student(Base):
    ...
    topic_progress = relationship("StudentTopicProgress")
    practice_sets = relationship("PracticeSet")
    achievements = relationship("StudentAchievement")
    assessments = relationship("Assessment")
    reports = relationship("ParentReport")
